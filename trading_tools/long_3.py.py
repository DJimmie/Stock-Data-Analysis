...
def trade_criteria(indicator_dict):
    ...
    if indicator_dict['SMA_5']>indicator_dict['SMA_180']:
        trade_status_line[symbol]['SMA5_ovr_SMA180']=1
    else:
    ...
    if (indicator_dict['SMA_50']<indicator_dict['SMA_180']) and indicator_dict['ratio_M50M180']<=1:
        ...
        trade_status_line[symbol]['SMA50_under_SMA180']=0

    if indicator_dict['close']>indicator_dict['SMA_180']:
        trade_status_line[symbol]['CLOSE_ovr_SMA_180']=1
    else:
        trade_status_line[symbol]['CLOSE_ovr_SMA_180']=0
...
def send_results_to_file(data,file_action='a'):
    ...
    with open('long_3_results.txt', file_action) as file:
        file.write(output_s)
        file.write('\n\n')
